...
export default async function MaterialsLibraryPage() {
    ...
    // Fetch all materials uploaded by this teacher
    ...
    return (
        <div className="min-h-screen bg-muted/20 p-8 space-y-8">
            ...
            <div className="flex items-center justify-between">
                ...
                <Link href="/teacher/content/materials/upload">
                    <Button>
            ...
            <Card>
                <CardHeader>
                    ...
                    <CardDescription>Files you've uploaded for your classes</CardDescription>
                </CardHeader>
                <CardContent>
